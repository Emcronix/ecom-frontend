  ...
  return (
    <div className="lg:px-[15px] px-[20px] sm:px-[50px] ">
      <h1 className="font-bold xl:text-4xl text-2xl py-4">
        Emcronix is a global leader in life at home.
      </h1>

      <div className="text-sm sm:text-base">
        Whether you just moved into a new home or looking to revamp your current
        one, we at Emcronix are here to inspire you with affordable home
        ...
        for you. Shopping at Emcronix is a bit different and exciting compared to
        ...
        you to explore. When you visit Emcronix store, make yourself at home in
      ...
      <p className=" w-5/6 font-normal py-4">
        Since most Emcronix furnishing is flat-packed, they are quite easy to
