          ...
          >
            <div className=" text-green-800 grid sm:grid-cols-3 grid-cols-2 gap-3 grid-rows-3">
              <TabImage
                ...
                alt={
                  labelData[uniqueRoomCategories[0]]?.[0]?.productCategory ||
                  "Room image"
                }
                handleTab={handleTab}
              ...
              <div className="overflow-hidden relative">
                <Image
                  ...
                  alt={
                    labelData[uniqueRoomCategories[1]]?.[0]?.productCategory ||
                    "Room image"
                  }
                  width={450}
                  height={350}
              ...
              <TabImage
                ...
                alt={
                  labelData[uniqueRoomCategories[2]]?.[0]?.productCategory ||
                  "Room image"
                }
                width={450}
                height={700}
              ...
              <TabImage
                ...
                alt={
                  labelData[uniqueRoomCategories[3]]?.[0]?.productCategory ||
                  "Room image"
                }
                handleTab={handleTab}
                width={450}
              ...
              <div className="overflow-hidden">
                <Image
                  ...
                  alt={
                    labelData[uniqueRoomCategories[4]]?.[0]?.productCategory ||
                    "Room image"
                  }
                  width={450}
                  height={350}
              ...
              <div className="bg-teal-100 overflow-hidden ">
                <Image
                  ...
                  alt={
                    labelData[uniqueRoomCategories[5]]?.[0]?.productCategory ||
                    "Room image"
                  }
                  width={450}
                  height={350}
              ...
              {loadMoreAll && (
                <TabImage
                  ...
                  alt={
                    labelData[uniqueRoomCategories[6]]?.[0]?.productCategory ||
                    "Room image"
                  }
                  handleTab={handleTab}
              ...
              {loadMoreAll && (
                <div className="overflow-hidden relative">
                  <Image
                    ...
                    alt={
                      labelData[uniqueRoomCategories[7]]?.[0]
                        ?.productCategory || "Room image"
                    }
                    width={450}
                    height={350}
                  />
              ...
              {loadMoreAll && (
                <TabImage
                  ...
                  alt={
                    labelData[uniqueRoomCategories[8]]?.[0]?.productCategory ||
                    "Room image"
                  }
                  width={450}
                  height={700}
              ...
              {loadMoreAll && (
                <TabImage
                  ...
                  alt={
                    labelData[uniqueRoomCategories[9]]?.[0]?.productCategory ||
                    "Room image"
                  }
                  handleTab={handleTab}
                  width={450}
              ...
              {loadMoreAll && (
                <div className="overflow-hidden">
                  <Image
                    ...
                    alt={
                      labelData[uniqueRoomCategories[10]]?.[0]
                        ?.productCategory || "Room image"
                    }
                    width={450}
                    height={350}
              ...
              {loadMoreAll && (
                <div className="bg-teal-100 overflow-hidden ">
                  <Image
                    ...
                    alt={
                      labelData[uniqueRoomCategories[11]]?.[0]
                        ?.productCategory || "Room image"
                    }
                    width={450}
                    height={350}
