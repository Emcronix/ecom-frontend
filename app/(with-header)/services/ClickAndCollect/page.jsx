            ...
            <section className="w-full pt-40">
                <div className="flex flex-wrap md:flex-nowrap gap-y-3">
                    <div className="w-full md:w-2/5 flex flex-col justify-center">
                        ...
                        <p className="text-justify px-3 opacity-90 mb-3">
                            With Emcronix Click and collect, you’re in control. Place an order online when it’s convenient and choose when and where to collect it. You’ll still make a trip, but we’ll gather your items so that you have more time and energy for assembling instead.
                        </p>
                ...
                <div className="md:w-[60%] mt-6">
                    <p className="text-justify px-3 opacity-80 mb-3">
                        ...
                        <a href="" className="underline">Emcronix store</a>,
                        <a href="" className="underline">Pick-up locker*</a>
                        (free for Emcronix Family members) or an external
            ...
            <section id='options'>
                <div className='flex-col md:w-2/3 my-8'>
                    ...
                    <p className='text-justify px-3 opacity-90 my-3'>
                        You can collect your order at an Emcronix store or a local Pick-up location. Pricing details, approximate lead time, maximum package specifications, Pick-up locations, etc. are specified below.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="col-span-1">
                        <div className="pb-[56.49761904761905%] relative">
                            <Image loading="lazy" src="/images/services/ClickCollectService/car.jpg"
                                alt="Cars parked in front of an Emcronix store"
                                width={300}
                                height={300}
                                className="absolute inset-0 w-full h-full object-cover"  />
                        </div>
                        <div className="p-4">
                            <h3 className="text-lg font-semibold">Collect at an Emcronix store</h3>
                            <ul className="mt-2 list-disc pl-4">
                                <li>$5 flat rate (<a href="">free for Emcronix Family members</a>)</li>
                        ...
                        >View all Emcronix store locations</a>
                    </div>
                    <div className="col-span-1">
                        <div className="pb-[56.2%] relative">
                            <Image loading="lazy" 
                            src="/images/services/ClickCollectService/pickup.jpg"
                                alt="A person riding a cargo bicycle with Emcronix boxes"
                                className="absolute inset-0 w-full h-full object-cover"
                                width={300}
                                height={300}
                                 />
                        ...
                        <a href=""
                            className="block px-4 py-2 text-center bg-black text-white rounded-full mt-4 w-[270px]"
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-2">Enhance your Emcronix online shopping experience with convenient package pickup service. Choose your preferred pickup location during checkout.</p>
                        </div>
                        <a href=""
                            className="block px-4 py-2 text-center bg-black text-white rounded-full mt-4 w-[320px]"
            ...
            <section id='works'>
                <div className="w-full md:w-2/3 mb-16">
                    ...
                    <ul type='1' className="pl-8 opacity-90">
                        <li className="mb-3"><strong className="opacity-90">Step 1:</strong> Choose ‘Click and collect’ at checkout and you will be able to select an <a href="" className="underline">Emcronix Store</a>,
            ...
            <section className='mb-4' id='know'>
                <div className="w-full md:w-2/3 mb-16">
                    ...
                    <ul className="list-disc list-inside opacity-90">
                        ...
                        <li className="mb-3 ml-6 ">If you can’t place an order at your desired <a href="" className="underline">Emcronix store</a>, try another location, remove an out-of-stock item from your cart or order later when stock is replenished.</li>
                        ...
                        <li className="mb-3 ml-6 ">Shopping for your business? Check out <a href="" className="underline">Emcronix for Business</a>. We’ll do more work for you so that you can spend more time on your customers.</li>
                    </ul>
                </div>
                <hr className="mt-20" />
            </section>
